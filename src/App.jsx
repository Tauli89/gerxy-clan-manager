...
function MyPage({ user, memberList, warList, accountList, db }) {
  ...
  // Egg Hatching Times — Index = Timer Speed Level (0=0%, 1=10%, 2=20%, ... 25=250%)
  // Quelle: PDF Seite 9 (aktualisiert)
  const EGG_TIMES = {
  ...
  // Haustier-Beschwörungswahrscheinlichkeiten — aktualisiert nach PDF Seiten 4–6
  // Jeder Level einzeln eingetragen für präzise Floor-Logik
  const PET_PROBS = {
    1:[99,1,0,0,0,0],
    2:[92,8,0,0,0,0],
    3:[80,20,0,0,0,0],
    4:[78.5,21.5,0,0,0,0],
    5:[76.89,23.11,0,0,0,0],
    6:[75.15,24.85,0,0,0,0],
    7:[72.96,26.71,0.34,0,0,0],
    8:[70.73,28.71,0.56,0,0,0],
    9:[68.2,30.87,0.93,0,0,0],
    10:[65.26,33.18,1.55,0,0,0],
    11:[61.74,35.67,2.59,0,0,0],
    12:[57.33,38.35,4.32,0,0,0],
    13:[51.58,41.22,7.2,0,0,0],
    14:[43.69,44.31,12,0,0,0],
    15:[32.36,47.64,20,0,0,0],
    16:[27.99,51.21,20.8,0,0,0],
    17:[23.32,55.05,21.63,0,0,0],
    18:[18.33,59.18,22.5,0,0,0],
    19:[12.99,63.62,23.4,0,0,0],
    20:[17.5,58.17,24.33,0,0,0],
    21:[17.5,57.19,25.31,0,0,0],
    22:[17.5,56.18,26.32,0,0,0],
    23:[17.5,55.13,27.37,0,0,0],
    24:[17.5,54.03,28.47,0,0,0],
    25:[17.5,52.89,29.6,0,0,0],
    26:[17.5,51.71,30.79,0,0,0],
    27:[17.5,50.48,32.02,0,0,0],
    28:[17.5,49.13,33.3,0.07,0,0],
    29:[17.5,47.75,34.63,0.12,0,0],
    30:[17.5,46.28,36.02,0.2,0,0],
    31:[17.5,44.7,37.46,0.34,0,0],
    32:[17.5,42.98,38.96,0.56,0,0],
    33:[17.5,41.05,40.52,0.93,0,0],
    34:[17.5,38.81,42.14,1.55,0,0],
    35:[17.5,36.09,43.82,2.59,0,0],
    36:[17.5,32.61,45.57,4.32,0,0],
    37:[17.5,27.9,47.4,7.2,0,0],
    38:[17.5,21.21,49.29,12,0,0],
    39:[17.5,11.23,51.27,20,0,0],
    40:[17.5,16.5,45.3,20.7,0,0],
    41:[17.5,16.5,44.58,21.42,0,0],
    42:[17.5,16.5,43.83,22.17,0,0],
    43:[17.5,16.5,43.05,22.95,0,0],
    44:[17.5,16.5,42.25,23.75,0,0],
    45:[17.5,16.5,41.42,24.59,0,0],
    46:[17.5,16.5,40.48,25.45,0.07,0],
    47:[17.5,16.5,39.54,26.34,0.12,0],
    48:[17.5,16.5,38.54,27.26,0.2,0],
    49:[17.5,16.5,37.45,28.21,0.34,0],
    50:[17.5,16.5,36.24,29.2,0.56,0],
    51:[17.5,16.5,34.85,30.22,0.93,0],
    52:[17.5,16.5,33.17,31.28,1.55,0],
    53:[17.5,16.5,31.03,32.37,2.59,0],
    54:[17.5,16.5,28.17,33.51,4.32,0],
    55:[17.5,16.5,24.12,34.68,7.2,0],
    56:[17.5,16.5,18.11,35.89,12,0],
    57:[17.5,16.5,8.85,37.15,20,0],
    58:[17.5,16.5,16.5,29.3,20.2,0],
    59:[17.5,16.5,16.5,29.1,20.4,0],
    60:[17.5,16.5,16.5,28.89,20.61,0],
    61:[17.5,16.5,16.5,28.69,20.81,0],
    62:[17.5,16.5,16.5,28.48,21.02,0],
    63:[17.5,16.5,16.5,28.27,21.23,0],
    64:[17.5,16.5,16.5,28.06,21.44,0],
    65:[17.5,16.5,16.5,27.84,21.66,0],
    66:[17.5,16.5,16.5,27.63,21.87,0],
    67:[17.5,16.5,16.5,27.41,22.09,0],
    68:[17.5,16.5,16.5,27.19,22.31,0],
    69:[17.5,16.5,16.5,26.96,22.54,0],
    70:[17.5,16.5,16.5,26.74,22.76,0],
    71:[17.5,16.5,16.5,26.44,22.99,0.07],
    72:[17.5,16.5,16.5,26.16,23.22,0.12],
    73:[17.5,16.5,16.5,25.85,23.45,0.2],
    74:[17.5,16.5,16.5,25.48,23.69,0.34],
    75:[17.5,16.5,16.5,25.02,23.92,0.56],
    76:[17.5,16.5,16.5,24.4,24.16,0.93],
    77:[17.5,16.5,16.5,23.54,24.4,1.55],
    78:[17.5,16.5,16.5,22.26,24.65,2.59],
    79:[17.5,16.5,16.5,20.29,24.89,4.32],
    80:[17.5,16.5,16.5,17.16,25.14,7.2],
    81:[17.5,16.5,16.5,12.1,25.4,12],
    82:[17.5,16.5,16.5,16.5,13,20],
    83:[17.5,16.5,16.5,16.5,12.74,20.26],
    84:[17.5,16.5,16.5,16.5,12.48,20.52],
    85:[17.5,16.5,16.5,16.5,12.21,20.79],
    86:[17.5,16.5,16.5,16.5,11.94,21.06],
    87:[17.5,16.5,16.5,16.5,11.67,21.33],
    88:[17.5,16.5,16.5,16.5,11.39,21.61],
    89:[17.5,16.5,16.5,16.5,11.11,21.89],
    90:[17.5,16.5,16.5,16.5,10.82,22.18],
    91:[17.5,16.5,16.5,16.5,10.54,22.46],
    92:[17.5,16.5,16.5,16.5,10.24,22.76],
    93:[17.5,16.5,16.5,16.5,9.95,23.05],
    94:[17.5,16.5,16.5,16.5,9.65,23.35],
    95:[17.5,16.5,16.5,16.5,9.34,23.66],
    96:[17.5,16.5,16.5,16.5,9.04,23.96],
    97:[17.5,16.5,16.5,16.5,8.72,24.28],
    98:[17.5,16.5,16.5,16.5,8.41,24.59],
    99:[17.5,16.5,16.5,16.5,8.09,24.91],
    100:[15,15,15,15,15,25],
  };

  // Reittier-Beschwörungswahrscheinlichkeiten — aktualisiert nach PDF Seiten 1–3
  // Jeder Level einzeln eingetragen für präzise Floor-Logik
  const MOUNT_PROBS = {
    1:[100,0,0,0,0,0],
    2:[99.99,0.01,0,0,0,0],
    3:[99.98,0.02,0,0,0,0],
    4:[99.97,0.03,0,0,0,0],
    5:[99.95,0.05,0,0,0,0],
    6:[99.92,0.08,0,0,0,0],
    7:[99.86,0.14,0,0,0,0],
    8:[99.76,0.24,0,0,0,0],
    9:[99.59,0.41,0,0,0,0],
    10:[99.3,0.7,0,0,0,0],
    11:[98.81,1.19,0,0,0,0],
    12:[97.98,2.02,0,0,0,0],
    13:[96.57,3.43,0,0,0,0],
    14:[94.17,5.83,0,0,0,0],
    15:[90.09,9.9,0,0,0,0],
    16:[83.16,16.84,0,0,0,0],
    17:[80,20,0,0,0,0],
    18:[75,25,0,0,0,0],
    19:[68.75,31.25,0,0,0,0],
    20:[60.94,39.06,0,0,0,0],
    21:[51.17,48.83,0,0,0,0],
    22:[38.89,61.03,0.07,0,0,0],
    23:[23.59,76.29,0.12,0,0,0],
    24:[17.5,82.3,0.2,0,0,0],
    25:[17.5,82.16,0.34,0,0,0],
    26:[17.5,81.94,0.56,0,0,0],
    27:[17.5,81.57,0.93,0,0,0],
    28:[17.5,80.94,1.55,0,0,0],
    29:[17.5,79.91,2.59,0,0,0],
    30:[17.5,78.18,4.32,0,0,0],
    31:[17.5,75.3,7.2,0,0,0],
    32:[17.5,70.5,12,0,0,0],
    33:[17.5,62.5,20,0,0,0],
    34:[17.5,58.5,24,0,0,0],
    35:[17.5,53.7,28.8,0,0,0],
    36:[17.5,47.94,34.56,0,0,0],
    37:[17.5,41.03,41.47,0,0,0],
    38:[17.5,32.66,49.77,0.07,0,0],
    39:[17.5,22.66,59.72,0.12,0,0],
    40:[17.5,16.5,65.8,0.2,0,0],
    41:[17.5,16.5,65.66,0.34,0,0],
    42:[17.5,16.5,65.44,0.56,0,0],
    43:[17.5,16.5,65.07,0.93,0,0],
    44:[17.5,16.5,64.44,1.55,0,0],
    45:[17.5,16.5,63.41,2.59,0,0],
    46:[17.5,16.5,61.68,4.32,0,0],
    47:[17.5,16.5,58.8,7.2,0,0],
    48:[17.5,16.5,54,12,0,0],
    49:[17.5,16.5,46,20,0,0],
    50:[17.5,16.5,44.5,21.5,0,0],
    51:[17.5,16.5,42.89,23.11,0,0],
    52:[17.5,16.5,41.15,24.85,0,0],
    53:[17.5,16.5,39.29,26.71,0,0],
    54:[17.5,16.5,37.29,28.71,0,0],
    55:[17.5,16.5,35.06,30.87,0.07,0],
    56:[17.5,16.5,32.7,33.18,0.12,0],
    57:[17.5,16.5,30.13,35.67,0.2,0],
    58:[17.5,16.5,27.32,38.35,0.34,0],
    59:[17.5,16.5,24.22,41.22,0.56,0],
    60:[17.5,16.5,20.75,44.31,0.93,0],
    61:[17.5,16.5,16.81,47.64,1.55,0],
    62:[17.5,16.5,16.5,46.91,2.59,0],
    63:[17.5,16.5,16.5,45.18,4.32,0],
    64:[17.5,16.5,16.5,42.3,7.2,0],
    65:[17.5,16.5,16.5,37.5,12,0],
    66:[17.5,16.5,16.5,29.5,20,0],
    67:[17.5,16.5,16.5,28.9,20.6,0],
    68:[17.5,16.5,16.5,28.28,21.22,0],
    69:[17.5,16.5,16.5,27.64,21.86,0],
    70:[17.5,16.5,16.5,26.99,22.51,0],
    71:[17.5,16.5,16.5,26.24,23.19,0.07],
    72:[17.5,16.5,16.5,25.5,23.88,0.12],
    73:[17.5,16.5,16.5,24.7,24.6,0.2],
    74:[17.5,16.5,16.5,23.83,25.33,0.34],
    75:[17.5,16.5,16.5,22.85,26.1,0.56],
    76:[17.5,16.5,16.5,21.69,26.88,0.93],
    77:[17.5,16.5,16.5,20.26,27.69,1.55],
    78:[17.5,16.5,16.5,18.39,28.51,2.59],
    79:[17.5,16.5,16.5,15.81,29.37,4.32],
    80:[17.5,16.5,16.5,16.5,25.8,7.2],
    81:[17.5,16.5,16.5,16.5,21,12],
    82:[17.5,16.5,16.5,16.5,13,20],
    83:[17.5,16.5,16.5,16.5,12.74,20.26],
    84:[17.5,16.5,16.5,16.5,12.48,20.52],
    85:[17.5,16.5,16.5,16.5,12.21,20.79],
  ...
  // Skill-Beschwörungswahrscheinlichkeiten — aktualisiert nach PDF Seiten 12–14
  // Jeder Level einzeln eingetragen für präzise Floor-Logik
  const SKILL_PROBS = {
    1:[99.5,0.5,0,0,0,0],
    2:[96,4,0,0,0,0],
    ...
    5:[88.6,11.4,0,0,0,0],
    6:[87,13,0,0,0,0],
    7:[85.18,14.82,0,0,0,0],
    8:[83.08,16.89,0.03,0,0,0],
    9:[80.68,19.25,0.06,0,0,0],
    10:[77.92,21.95,0.12,0,0,0],
    11:[74.73,25.02,0.25,0,0,0],
    12:[70.97,28.53,0.5,0,0,0],
    13:[66.48,32.52,1,0,0,0],
    14:[60.93,37.07,2,0,0,0],
    15:[53.74,42.26,4,0,0,0],
    16:[47.38,48.18,4.44,0,0,0],
    17:[40.15,54.92,4.93,0,0,0],
    18:[31.88,62.61,5.47,0.03,0,0],
    19:[22.49,71.38,6.07,0.06,0,0],
    20:[17.5,75.63,6.74,0.12,0,0],
    21:[17.5,74.77,7.48,0.25,0,0],
    22:[17.5,73.69,8.31,0.5,0,0],
    23:[17.5,72.28,9.22,1,0,0],
    24:[17.5,70.27,10.23,2,0,0],
    25:[17.5,67.14,11.36,4,0,0],
    26:[17.5,65.67,12.61,4.22,0,0],
    27:[17.5,64.05,13.99,4.45,0,0],
    28:[17.5,62.27,15.53,4.7,0,0],
    29:[17.5,60.3,17.24,4.96,0,0],
    30:[17.5,58.13,19.14,5.23,0,0],
    31:[17.5,55.74,21.24,5.51,0,0],
    32:[17.5,53.1,23.58,5.82,0,0],
    33:[17.5,50.19,26.17,6.14,0,0],
    34:[17.5,46.97,29.05,6.48,0,0],
    35:[17.5,43.42,32.25,6.83,0,0],
    36:[17.5,39.5,35.8,7.21,0,0],
    37:[17.5,35.16,39.73,7.61,0,0],
    38:[17.5,30.37,44.11,8.02,0,0],
    39:[17.5,25.05,48.96,8.46,0.03,0],
    40:[17.5,19.17,54.34,8.93,0.06,0],
    41:[17.5,16.5,56.45,9.42,0.12,0],
    42:[17.5,16.5,55.81,9.94,0.25,0],
    43:[17.5,16.5,55.01,10.49,0.5,0],
    44:[17.5,16.5,53.94,11.06,1,0],
    45:[17.5,16.5,52.33,11.67,2,0],
    46:[17.5,16.5,49.69,12.31,4,0],
    47:[17.5,16.5,48.79,12.99,4.22,0],
    48:[17.5,16.5,47.84,13.71,4.45,0],
    49:[17.5,16.5,46.85,14.46,4.7,0],
    50:[17.5,16.5,45.79,15.25,4.96,0],
    51:[17.5,16.5,44.68,16.09,5.23,0],
    52:[17.5,16.5,43.51,16.98,5.51,0],
    53:[17.5,16.5,42.27,17.91,5.82,0],
    54:[17.5,16.5,40.97,18.9,6.14,0],
    55:[17.5,16.5,39.59,19.94,6.48,0],
    56:[17.5,16.5,38.13,21.03,6.83,0],
    57:[17.5,16.5,36.6,22.19,7.21,0],
    58:[17.5,16.5,34.99,23.41,7.61,0],
    59:[17.5,16.5,33.28,24.7,8.02,0],
    60:[17.5,16.5,31.48,26.06,8.46,0],
    61:[17.5,16.5,29.58,27.49,8.93,0],
    62:[17.5,16.5,27.58,29,9.42,0],
    63:[17.5,16.5,25.47,30.59,9.94,0],
    64:[17.5,16.5,23.24,32.28,10.49,0],
    65:[17.5,16.5,20.88,34.05,11.06,0],
    66:[17.5,16.5,16.5,37.83,11.67,0],
    67:[17.5,16.5,16.5,37.19,12.31,0],
    68:[17.5,16.5,16.5,36.48,12.99,0.03],
    69:[17.5,16.5,16.5,35.73,13.71,0.06],
    70:[17.5,16.5,16.5,34.92,14.46,0.12],
    71:[17.5,16.5,16.5,34,15.25,0.25],
    72:[17.5,16.5,16.5,32.91,16.09,0.5],
    73:[17.5,16.5,16.5,31.52,16.98,1],
    74:[17.5,16.5,16.5,29.59,17.91,2],
    75:[17.5,16.5,16.5,26.6,18.9,4],
    76:[17.5,16.5,16.5,25.33,19.94,4.23],
    77:[17.5,16.5,16.5,23.99,21.03,4.48],
    78:[17.5,16.5,16.5,22.57,22.19,4.74],
    79:[17.5,16.5,16.5,21.08,23.41,5.01],
    80:[17.5,16.5,16.5,19.5,24.7,5.3],
    81:[17.5,16.5,16.5,17.83,26.06,5.61],
    82:[17.5,16.5,16.5,16.5,27.06,5.94],
    83:[17.5,16.5,16.5,16.5,26.72,6.28],
    84:[17.5,16.5,16.5,16.5,26.36,6.64],
    85:[17.5,16.5,16.5,16.5,25.97,7.03],
    86:[17.5,16.5,16.5,16.5,25.56,7.44],
    87:[17.5,16.5,16.5,16.5,25.13,7.87],
    88:[17.5,16.5,16.5,16.5,24.67,8.32],
    89:[17.5,16.5,16.5,16.5,24.19,8.81],
    90:[17.5,16.5,16.5,16.5,23.68,9.32],
    91:[17.5,16.5,16.5,16.5,23.14,9.86],
    92:[17.5,16.5,16.5,16.5,22.57,10.43],
    93:[17.5,16.5,16.5,16.5,21.96,11.04],
    94:[17.5,16.5,16.5,16.5,21.32,11.68],
    95:[17.5,16.5,16.5,16.5,20.65,12.35],
    96:[17.5,16.5,16.5,16.5,19.93,13.07],
    97:[17.5,16.5,16.5,16.5,19.17,13.83],
    98:[17.5,16.5,16.5,16.5,18.37,14.63],
    99:[17.5,16.5,16.5,16.5,17.52,15.48],
  ...
  // Floor-Logik: nimm den höchsten Key der <= aktuellem Level ist
  const probKeys = Object.keys(probData).map(Number).sort((a,b)=>a-b);
  const floorKey = probKeys.filter(k=>k<=summonLevel).pop() || probKeys[0];
  const curProbs = probData[floorKey];
  ...
  return (
    <div>
      ...
      {activeCalc==="aufstieg" && <AufstiegPlaner warList={warList} techTree={techTree} getTechTotalBonus={getTechTotalBonus} reittierKostenBonus={reittierKostenBonus} eiChanceBonus={eiChanceBonus} skillKostenBonus={skillKostenBonus}/>}
...
// ── AUFSTIEG PLANER ──────────────────────────────────────────
function AufstiegPlaner({ warList, techTree, getTechTotalBonus, reittierKostenBonus, eiChanceBonus, skillKostenBonus }) {
  ...
  const [skillRabatt,  setSkillRabatt]  = useState(0);
  const [petDropBonus, setPetDropBonus] = useState(0);
  const [mountRabatt,  setMountRabatt]  = useState(0);
  const [mountDropBonus, setMountDropBonus] = useState(0);

  // Ressourcen aus Guide: [zielLevel, basisKosten, label]
  const SKILL_ZIELE = {
  ...
  const PET_ZIELE = {
    "Episch":     { level: 15, basis: 7100,  label: "Episch (Lvl 15, 20%)",    hinweis: "Äquivalent zu Base-Ultimate. Günstig und einfach — gut bei schlechten Mythisch-Stats." },
  ...
  function berechneKosten(basis, rabattPct, dropBonusPct) {
    const mitRabatt = Math.round(basis * (1 - rabattPct / 100));
    const mitDrop   = dropBonusPct > 0 ? Math.round(basis / (1 + dropBonusPct / 100)) : basis;
    const beides    = (rabattPct > 0 && dropBonusPct > 0) ? Math.round(basis * (1 - rabattPct / 100) / (1 + dropBonusPct / 100)) : null;
    return { basis, mitRabatt: rabattPct > 0 ? mitRabatt : null, mitDrop: dropBonusPct > 0 ? mitDrop : null, beides };
  }
  ...
  const skillK     = berechneKosten(skillData.basis, skillRabatt, 0);
  const petK       = berechneKosten(petData.basis,   0,           petDropBonus);
  const mountK     = berechneKosten(mountData.basis, mountRabatt, mountDropBonus);

  const fmtNum = n => n >= 1000 ? Math.round(n/1000)+"k" : String(n);
  const KostenZeile = ({label, icon, data, suffix}) => (
    <div style={{padding:"12px 14px",background:"var(--bg2)",borderRadius:10,border:"1px solid var(--border)"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(120px,1fr))",gap:6,fontSize:12}}>
        <div style={{padding:"6px 10px",background:"var(--bg)",borderRadius:6,textAlign:"center"}}>
          <div style={{color:"var(--text3)",fontSize:10,marginBottom:2}}>Basis</div>
          <div style={{fontWeight:700,color:"var(--text)",fontSize:14}}>{fmtNum(data.basis)}</div>
          <div style={{fontSize:10,color:"var(--text3)"}}>{suffix}</div>
        </div>
        {data.mitRabatt && <div style={{padding:"6px 10px",background:"#22c55e10",border:"1px solid #22c55e30",borderRadius:6,textAlign:"center"}}>
          <div style={{color:"#22c55e",fontSize:10,marginBottom:2}}>Mit Rabatt</div>
          <div style={{fontWeight:700,color:"#22c55e",fontSize:14}}>{fmtNum(data.mitRabatt)}</div>
          <div style={{fontSize:10,color:"var(--text3)"}}>{suffix}</div>
        </div>}
        {data.mitDrop && <div style={{padding:"6px 10px",background:"#3b82f610",border:"1px solid #3b82f630",borderRadius:6,textAlign:"center"}}>
          <div style={{color:"#3b82f6",fontSize:10,marginBottom:2}}>Mit Extra-Drop</div>
          <div style={{fontWeight:700,color:"#3b82f6",fontSize:14}}>{fmtNum(data.mitDrop)}</div>
          <div style={{fontSize:10,color:"var(--text3)"}}>{suffix}</div>
        </div>}
        {data.beides && <div style={{padding:"6px 10px",background:"#a855f710",border:"1px solid #a855f730",borderRadius:6,textAlign:"center"}}>
          <div style={{color:"#a855f7",fontSize:10,marginBottom:2}}>Rabatt + Drop</div>
          <div style={{fontWeight:700,color:"#a855f7",fontSize:14}}>{fmtNum(data.beides)}</div>
          <div style={{fontSize:10,color:"var(--text3)"}}>{suffix}</div>
        </div>}
      </div>
    </div>
  ...
  const EI_PUNKTE = {Gewoehnlich:0,Selten:0,Episch:3200,Legendaer:6400,Ultimate:12800,Mythisch:0};
  const EI_PUNKTE_TAG2 = {Gewoehnlich:400,Selten:1600,Episch:3200,Legendaer:6400,Ultimate:12800,Mythisch:0};
  const REITTIER_BESCHWOREN_PTS = 1250;
  const REITTIER_GEMEINSAM_BESCHWOREN = 600;
  const REITTIER_GEMERGT_PTS = 600;
  const SKILL_BESCHWOREN_PTS = 125;
  const SKILL_UPGRADE_PTS = 125;
  const HAMMER_PUNKTE_PRO = 1;
  ...
  const reitPts = wReittier.beschworen * REITTIER_BESCHWOREN_PTS + wReittier.gemergt * REITTIER_GEMERGT_PTS;
  const skillPts = wSkills.beschworen * SKILL_BESCHWOREN_PTS + wSkills.upgrades * SKILL_UPGRADE_PTS;
  const hamPts  = wHaemmer * HAMMER_PUNKTE_PRO;
  ...
  const [bLevel,  setBLevel]  = useState(37);
  const BESCHWOERUNGS_KOSTEN = {
    Haustier: { kosten: l => {
      if (l<=1) return 200; if (l<=3) return 200+(l-1)*100; if (l<=6) return 300+(l-3)*100;
      if (l<=20) return 600+(l-7)*100; return 2300;
    }},
    Reittier: { kosten: () => 1000 },
    Skill:    { kosten: l => {
      if (l<=1) return 200; if (l<=4) return 200+(l-1)*200; if (l<=5) return 1000;
      if (l<=7) return 1200+(l-6)*200; if (l<=16) return 1600+(l-8)*200; return 4400;
    }},
  };
  const BESCHWOERUNGS_SUFFIX = { Haustier: "Eggshells", Reittier: "Clockwinder", Skill: "Tickets" };
  const BESCHWOERUNGS_ZIELE = {
    Haustier: ["Selten","Episch","Legendaer","Ultimate","Mythisch"],
    Reittier: ["Selten","Episch","Legendaer","Ultimate","Mythisch"],
    Skill:    ["Selten","Episch","Legendaer","Ultimate","Mythisch"],
  };
  // Wahrscheinlichkeit aus PET/MOUNT/SKILL_PROBS — wir nehmen bekannte Schwellwerte aus dem Guide
  ...
  // Kosten bis Level X berechnen (kumulativ)
  function kumKosten(typ, bisLevel) {
    let s = 0;
    const fn = BESCHWOERUNGS_KOSTEN[typ]?.kosten;
    if (!fn) return 0;
    for (let i = 1; i < bisLevel; i++) s += fn(i) * 20; // 20 Beschwörungen pro Level-Aufstieg
    return s;
  }
  ...
  const empfLevel = EMPF_LEVEL[bTyp]?.[bZiel] || bLevel;
  // Durchschnittliche Anzahl Beschwörungen bis zum Ziel bei gegebener Chance
  const CHANCEN_PCT = {
  ...
  // Kosten pro Beschwörung auf Ziel-Level (ca.)
  const kostenProBeschw = BESCHWOERUNGS_KOSTEN[bTyp]?.kosten(empfLevel) || 0;
      ...
      {subTab==="ressourcen" && (
        <div style={{display:"grid",gap:14}}>
          <div style={{padding:"10px 14px",background:"#c8850a15",border:"1px solid #c8850a30",borderRadius:8,fontSize:12,color:"#c8850a"}}>
            💡 Diese Ressourcen musst du <strong>vor dem Aufstieg</strong> angespart haben — danach sind deine Pets, Reittiere und Skills verloren!
          </div>
          ...
          <div className="card">
            ...
            <div style={{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap",alignItems:"center"}}>
              <label style={{fontSize:12,color:"var(--text3)"}}>Kosten-Rabatt (Tech Tree):</label>
              {[0,10,20,25,30].map(v=>(
                <button key={v} className={`btn btn-sm ${skillRabatt===v?"btn-gold":"btn-ghost"}`} onClick={()=>setSkillRabatt(v)}>{v===0?"Kein":v+"%"}</button>
              ))}
            </div>
            <KostenZeile label="Benötigte Skill-Tickets" icon="🎫" data={skillK} suffix="Tickets"/>
            <div style={{marginTop:8,fontSize:11,color:"var(--text3)"}}>Ziel: A1 Level {SKILL_ZIELE[skillZiel]?.level} · Basis aus Guide (2% Chance bei Lvl 24)</div>
          </div>

          {/* Pets */}
          <div className="card">
            <div className="card-title">🐾 Haustiere</div>
            <div style={{display:"flex",gap:10,marginBottom:12,flexWrap:"wrap"}}>
            ...
            <div style={{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap",alignItems:"center"}}>
              <label style={{fontSize:12,color:"var(--text3)"}}>Extra-Drop-Bonus:</label>
              {[0,25,50].map(v=>(
                <button key={v} className={`btn btn-sm ${petDropBonus===v?"btn-gold":"btn-ghost"}`} onClick={()=>setPetDropBonus(v)}>{v===0?"Kein":"+"+v+"%"}</button>
              ))}
            </div>
            <KostenZeile label="Benötigte Eggshells" icon="🥚" data={petK} suffix="Eggshells"/>
            <div style={{marginTop:8,fontSize:11,color:"var(--text3)"}}>Ziel: A1 Level {PET_ZIELE[petZiel]?.level} · 50% Extra Drop = ~33% effektiver Rabatt</div>
          </div>
          ...
          <div className="card">
            ...
            <div style={{display:"flex",gap:8,marginBottom:6,flexWrap:"wrap",alignItems:"center"}}>
              <label style={{fontSize:12,color:"var(--text3)"}}>Kosten-Rabatt:</label>
              {[0,10,24,25].map(v=>(
                <button key={v} className={`btn btn-sm ${mountRabatt===v?"btn-gold":"btn-ghost"}`} onClick={()=>setMountRabatt(v)}>{v===0?"Kein":v+"%"}</button>
              ))}
            </div>
            <div style={{display:"flex",gap:8,marginBottom:10,flexWrap:"wrap",alignItems:"center"}}>
              <label style={{fontSize:12,color:"var(--text3)"}}>Extra-Drop-Bonus:</label>
              {[0,25,50].map(v=>(
                <button key={v} className={`btn btn-sm ${mountDropBonus===v?"btn-gold":"btn-ghost"}`} onClick={()=>setMountDropBonus(v)}>{v===0?"Kein":"+"+v+"%"}</button>
              ))}
            </div>
            <KostenZeile label="Benötigte Clockwinder" icon="⚙️" data={mountK} suffix="Clockwinder"/>
            <div style={{marginTop:8,fontSize:11,color:"var(--text3)"}}>Ziel: A1 Level {MOUNT_ZIELE[mountZiel]?.level} · 24% Rabatt + 50% Drop = ~49% Gesamtrabatt laut Guide</div>
          </div>

          {/* Zusammenfassung */}
          <div className="card" style={{borderColor:"#a855f730"}}>
            <div className="card-title">📋 Dein Anspar-Ziel (Zusammenfassung)</div>
            <div style={{display:"grid",gap:6}}>
              {[
                ["🎫 Skill-Tickets",  skillK.beides??skillK.mitRabatt??skillK.basis, "Tickets"],
                ["🥚 Eggshells",      petK.beides??petK.mitDrop??petK.basis,         "Eggshells"],
                ["⚙️ Clockwinder",    mountK.beides??mountK.mitRabatt??mountK.basis, "Clockwinder"],
              ].map(([label, wert, suf])=>(
                <div key={label} style={{display:"flex",justifyContent:"space-between",padding:"8px 12px",background:"var(--bg2)",borderRadius:8,fontSize:13}}>
...
function TechTreePanel({ techTree, saveTechNode, getTechTotalLevels, getTechTotalBonus, getTechLvl, techFreeForgeBonus, offlineTechLevel, EGG_NODE_IDS, schmiedeTimerBonus, schmiedeKostenBonus, techTimerBonus, techKostenBonus, reittierChanceBonus, reittierKostenBonus, skillKostenBonus, eiChanceBonus }) {
  ...
  const LAYOUTS = {
    ...
    macht:        ["pair","pair","pair","pair","single","single","pair","pair","pair","pair","single","single"],
