...
function MyPage({ user, memberList, warList, accountList, db }) {
  ...
  // Key = Level, Value = [Gewöhnlich, Selten, Episch, Legendär, Ultimate, Mythisch]
  const PET_PROBS = {
    1:[99,1,0,0,0,0],
    2:[92,8,0,0,0,0],
    3:[80,20,0,0,0,0],
    ...
    65:[17.5,16.5,16.5,37.83,11.67,0],
    66:[17.5,16.5,16.5,29.5,20,0],
    80:[17.5,16.5,16.5,16.5,25.14,7.2],
  ...
  const SKILL_PROBS = {
    ...
    80:[17.5,16.5,16.5,16.5,24.7,5.3],
    81:[17.5,16.5,16.5,16.5,26.06,5.61],
